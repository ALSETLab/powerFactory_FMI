...
#ifdef SUNDIALS_6_4_1
DYMOLA_STATIC int superlu_init(void* vdata, int use_slui_data_variables, int jacobian_rowvals_needs_reset, void* sunctx) { return 1; }
#else
...
DYMOLA_STATIC int superlu_condition_number(void* vdata, double* condition_number, double* norm_of_inverse) { return 1; }
DYMOLA_STATIC void superlu_deallocate(void *vdata) { ; }
DYMOLA_STATIC void superlu_dealloc_interface_util(void* slui_util) { ; }

#ifndef SUNDIALS_6_4_1
...
#endif /* GODESS */
#endif /* not SUNDIALS_6_4_1 */
#endif /* not DYN_COMPILE_WITH_SPARSE */
